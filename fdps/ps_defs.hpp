...
#include"matrix3.hpp" // added by kentan
#include"matrix4.hpp"
...
namespace ParticleSimulator{
    ...
    typedef Vector4<F32> F32vec4; // subarutaro defined
    typedef Vector2<F64> F64vec2;
    typedef Vector3<F64> F64vec3;
    typedef Vector4<F64> F64vec4; // subarutaro defined
    ...
    typedef Matrix3<F32> F32mat3asym; //subarutaro defined
    typedef Matrix3<F64> F64mat3asym; //subarutaro defined
    typedef Matrix4<F32> F32mat4; //subarutaro defined
    typedef Matrix4<F64> F64mat4; //subarutaro defined
